...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 w-full z-50 bg-black-rich transition-all duration-500 flex items-center justify-between ${isScrolled ? 'bg-black-rich shadow-sm' : 'header'}`}>
            <div className="">
                <a href="/">
