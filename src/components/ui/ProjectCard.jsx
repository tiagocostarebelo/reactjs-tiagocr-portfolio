    ...
    return (
        ...
        >
            <div className="relative overflow-hidden bg-white rounded-lg">
                ...
                <div className="absolute bottom-0 left-0 w-full py-12 px-4 flex flex-col gap-1 duration-500 ease-out">
                    <h3 className="text-white text-xl font-semibold">
                        {project.title}
                    </h3>
                    <span className="text-white/90 text-sm font-medium transition-all duration-500 ease-out group-hover:text-teal group-hover:text-md">
                        View Work
                    </span>
                </div>
            </div>
